...
from Mut.inference_utils import mk_fasta_pp, mk_ss, mk_csf15, mk_trr100, make_input
from Mut.DLPacker_OPUS import utils, dlpacker
...
if __name__ == '__main__':
    ...
    preparation_config["mkdssp_path"] = os.path.join(os.path.abspath('.'), "Mut/mkdssp/mkdssp")
    ...
    model1.load_model(weights = "./Mut/DLPacker_OPUS/models/1/3dcnn.h5")
    model2 = utils.DLPModel(width = 128, nres = 6)
    model2.load_model(weights = "./Mut/DLPacker_OPUS/models/2/3dcnn.h5")
    model3 = utils.DLPModel(width = 128, nres = 6)
    model3.load_model(weights = "./Mut/DLPacker_OPUS/models/3/3dcnn.h5")
    model4 = utils.DLPModel(width = 128, nres = 6)
    model4.load_model(weights = "./Mut/DLPacker_OPUS/models/4/3dcnn.h5")
    model5 = utils.DLPModel(width = 128, nres = 6)
    model5.load_model(weights = "./Mut/DLPacker_OPUS/models/5/3dcnn.h5")  
    model6 = utils.DLPModel(width = 128, nres = 6)
    model6.load_model(weights = "./Mut/DLPacker_OPUS/models/6/3dcnn.h5")  
    model7 = utils.DLPModel(width = 128, nres = 6)
    model7.load_model(weights = "./Mut/DLPacker_OPUS/models/7/3dcnn.h5") 
